...
export default function ChantiersEmployePage() {
  ...
  return (
    <div className="space-y-10 md:space-y-14">
      {/* Header avec titre (sans bouton Ajouter pour Employé) */}
      <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6 md:gap-8">
        <div className="flex-1">
          ...
          <p className="text-sm md:text-[15px] text-gray-400/80 leading-relaxed font-normal">
            Suivez l'avancement des projets (lecture seule)
          </p>
        </div>
      </div>
          ...
          <div className="divide-y divide-white/[0.06]">
            {filteredChantiers.map((chantier) => {
              ...
              return (
                <Link
                  key={chantier.id}
                  href={`/dashboard/employe/chantiers/${chantier.id}`}
